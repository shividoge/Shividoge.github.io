...
(function($) {
 ...
 function ln_navigation() {
    ...
    smoothScrollLinks.on('click', function(e) {
        ...
        if (getWindowWidth() < 768) { // Assuming 768px is your mobile breakpoint
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function toggleChatBox() {
    ...
    if (isOpen) {
      ...
      chatContainer.style.height = "580px"; // Set a fixed height for the chat container
    ...
    if (messageText !== "") {
      ...
      setTimeout(() => {
        if (messageCount === 1) {
          ...
          appendBotMessage("We have notified our team and we will help you soon! While you wait, please feel free to look through the rest of our site.", true);
        }
